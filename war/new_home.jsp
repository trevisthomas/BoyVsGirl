...
<script>(function(d, s, id) {
  ...
  fjs.parentNode.insertBefore(js, fjs);
			...
			<div class="slide-out-div">
				...
				<div class="main">
					<div>
						<span id="logo"><img width="50%" src="/img/BvGLogoWhite.png" /></span>
					</div>
					<div>&nbsp;</div>
					...
					<div>&nbsp;</div>
					<a href="/new_showcase.jsp?who=Trevis">View His Favorites</a> | <a href="/new_showcase.jsp?who=Chrissy">View Her Favorites</a>
					<div>&nbsp;</div>
